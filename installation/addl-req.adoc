...
---
= Keystone對ONTAP和StorageGRID 的要求
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.軟體版本
. ONTAP 9.8 或更高版本
. Active IQ Unified Manager （Unified Manager）版本高於 9.10 且低於 9.16P2
...
. 請確保已設定高於 9.10 且低於 9.16P2 的 Unified Manager。有關安裝 Unified Manager 的資訊，請參閱以下連結：
+
