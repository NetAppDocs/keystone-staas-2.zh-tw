...
. 選擇“*集群中的磁碟區*”標籤。
+
image:console-volumes-clusters-multiple-sub-1.png["多個訂閱的集群中的捲的螢幕截圖"]

+
您可以查看 Keystone 訂閱中所有叢集磁碟區的詳細資訊，包括磁碟區名稱、訂閱號碼、節點序號、符合 QoS 原則、叢集名稱、主機名稱和效能服務層級。您可以監控已配置容量、邏輯和實體使用率、冷資料和熱資料。您還可以獲得以下概覽：
